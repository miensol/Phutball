...
namespace ForTesting
{
    ...
    public static class SpecificationExtensions
    {
        ...
        {
            Assert.AreEqual(expected, actual, message, expected, actual);
            return expected;
        }
        ...
        {
            expectedItems.ToList().ForEach(expected => actual.ShouldContain(expected));
        }
        ...
        public static void AssertListMatches(IList actualList, IList expectedList)
        {
            ...
            string message = "";
            actual.ToArray().ToList().ForEach(o => message += string.Format("Extra:  {0}\n", o));
            expected.ToArray().ToList().ForEach(o => message += string.Format("Missing:  {0}\n", o));
        ...
        public static Exception ThrownException(this Action me)
        {
            try
            {
                me();
        ...
        public static Exception CatchException(Action me)
        {
